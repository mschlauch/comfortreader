 ...
 */
public class PositionPickerPreference extends DialogPreference {
    ...
    public PositionPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PositionPickerPreference(Context context, AttributeSet attrs, int defStyleAttr) {
